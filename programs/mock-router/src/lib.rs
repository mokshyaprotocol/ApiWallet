...
pub mod mock_router {
    ...
    /// Simulate a routed swap. Records nothing; just asserts the transfer
    /// authority signed and echoes the amounts to the log.
    pub fn swap(ctx: Context<Swap>, amount_in: u64, min_amount_out: u64) -> Result<()> {
        msg!(
            "mock router swap: authority={} amount_in={} min_out={}",
